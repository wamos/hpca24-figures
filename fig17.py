...
bar_width = 0.4  # Adjust the width of each bar
...
for i in range(len(values)):
    ...
    for bar, value in zip(bars, values[i]):
        ax.text(bar.get_x() + bar.get_width() / 2, bar.get_height() + 0.2, str(value),
...
ax.set_xticklabels(categories, fontproperties=custom_font, fontsize="12")
